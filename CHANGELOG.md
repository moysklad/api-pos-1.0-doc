...
### 23-04-2026
### Добавлено
- Добавлены новые типы маркированной продукции `TOYS` (Детские игрушки), `CONSERVE` (Консервированные продукты), `CONSTRUCTION` (Строительные материалы), `RADIO` (Радиоэлектроника), `GADGETS` (Радиоэлектроника. Ноутбуки и смартфоны)

### 07-04-2026
### Изменено
- Изменено описание типа маркированной продукции `FOOD_SUPPLEMENT`

### 23-03-2026
### Добавлено
- Добавлен новый тип маркированной продукции `FURSLP` (Натуральный мех)

### 05-02-2026
### Добавлены
- Добавлены поля `defaultCompanyVat`, `useCompanyVat`  в сущность `Точка продаж`

### 04-02-2026
### Добавлено
- Добавлены новые типы маркированной продукции: `AUTO_FLUIDS` (Моторные масла), `GROCERY` (Бакалея), `CHEMISTRY` (Косметика, бытовая химия, товары личной гигиены)
...
### 22-12-2025
### Исправлено
- Исправлен ответ на запрос бонусных баллов контрагента.

### 04-12-2025
### Добавлено
- Добавлено поле `markingEnabled` и объект `piotSettings` с полями `mode`, `host` в сущность `Точка продаж`
